...
SELECT COUNT( * ) AS number_free_facilities
FROM Facilities
WHERE membercost =0
...
LEFT JOIN Facilities facilities ON facilities.facid = bookings.facid
...
ORDER BY guest_cost, member_cost
